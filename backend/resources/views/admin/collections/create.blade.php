                ...
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="mb-0 fw-bold">Thêm Bộ sưu tập mới</h4>
                                <small class="text-muted">Điền thông tin để tạo bộ sưu tập</small>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-7 mx-auto">
                                <form action="{{route('admin.collections.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control @error('released') is-invalid @enderror" id="released" name="released" placeholder="Năm ra mắt"
                                        value="{{old('released')}}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea rows="6" class="form-control @error('collection_desc') is-invalid @enderror" id="collection_desc" name="collection_desc" placeholder="Nhập mô tả về bộ sưu tập...">{{old('collection_desc')}}</textarea>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @enderror
                                        <div class="mt-2">
                                            <img src="#" alt="Image Preview" id="banner_img_preview" class="d-none rounded border" style="max-width: 300px; max-height: 200px;">
                                        </div>
                                    </div>
