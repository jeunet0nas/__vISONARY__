                ...
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="mb-0 fw-bold">Cập nhật mã giảm giá</h4>
                                <small class="text-muted">Chỉnh sửa thông tin mã giảm giá</small>
                            </div>
                            ...
                            <div class="col-md-7 mx-auto">
                                <form action="{{route('admin.coupons.update', $coupon->coupon_id)}}" method="post">
                                    ...
                                    <div class="form-floating mb-4">
                                        <input type="datetime-local" class="form-control @error('valid_until') is-invalid @enderror" id="valid_until" name="valid_until" placeholder="Hiệu lực"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save me-2"></i>Cập nhật mã giảm giá
                                        </button>
                                    </div>
                            </form>
                        </div>
