                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small class="text-muted">Chỉnh sửa thông tin sản phẩm</small>
                            </div>
                                ...
                                <form action="{{route('admin.products.update', $product->slug)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating mb-3">
                                                ...
                                                value="{{old('released_at', $product->released_at)}}">
                                    ...
                                    <div class="form-floating mb-3">
                                        <select class="form-control @error('collection_id') is-invalid @enderror" id="collection_id" name="collection_id">
                                            <option value="" disabled>Chọn BST</option>
                                            @foreach($collections as $collection)
                                                <option value="{{ $collection->collection_id }}" {{ old('collection_id',$product->collection_id) == $collection->collection_id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="shape" id="shape" class="form-select @error('shape') is-invalid @enderror">
                                                    <option value="Vuông" {{ old('shape', $product->shape) == 'Vuông' ? 'selected' : '' }}>Vuông</option>
                                                    <option value="Oval" {{ old('shape', $product->shape) == 'Oval' ? 'selected' : '' }}>Oval</option>
                                                    <option value="Tròn" {{ old('shape', $product->shape) == 'Tròn' ? 'selected' : '' }}>Tròn</option>
                                                    <option value="Cat-eye" {{ old('shape', $product->shape) == 'Cat-eye' ? 'selected' : '' }}>Cat-eye</option>
                                                    <option value="Wraparound" {{ old('shape', $product->shape) == 'Wraparound' ? 'selected' : '' }}>Wraparound</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="material" id="material" class="form-select @error('material') is-invalid @enderror">
                                                    <option value="Acetate" {{ old('material', $product->material) == 'Acetate' ? 'selected' : '' }}>Acetate</option>
                                                    <option value="Nylon" {{ old('material', $product->material) == 'Nylon' ? 'selected' : '' }}>Nylon</option>
                                                    <option value="Kim loại" {{ old('material', $product->material) == 'Kim loại' ? 'selected' : '' }}>Kim loại</option>
                                                    <option value="Mixed" {{ old('material', $product->material) == 'Mixed' ? 'selected' : '' }}>Mixed</option>
                                                </select>
                                                @error('material')
                                                    <span class="invalid-feedback">
                                                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea rows="6" class="form-control @error('product_desc') is-invalid @enderror" id="product_desc" name="product_desc" placeholder="Nhập mô tả chi tiết về sản phẩm...">{{old('product_desc', $product->product_desc)}}</textarea>
                                        @error('product_desc')
                                            <span class="invalid-feedback">
                                                <strong>{{$message}}</strong>
                                            </span>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @enderror
                                        <div class="mt-2">
                                            <img src="{{asset($product->thumbnail)}}" alt="Current" class="rounded border me-2" style="max-width: 200px; max-height: 200px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="mt-2">
                                                @if($product->first_img)
                                                    <img src="{{asset($product->first_img)}}" alt="Current" class="rounded border me-2" style="max-width: 150px; max-height: 150px;">
                                                @endif
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="mt-2">
                                                @if($product->second_img)
                                                    <img src="{{asset($product->second_img)}}" alt="Current" class="rounded border me-2" style="max-width: 150px; max-height: 150px;">
                                                @endif
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="mt-2">
                                                @if($product->third_img)
                                                    <img src="{{asset($product->third_img)}}" alt="Current" class="rounded border me-2" style="max-width: 150px; max-height: 150px;">
                                                @endif
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            @enderror>
                                            <div class="mt-2">
                                                @if($product->fourth_img)
                                                    <img src="{{asset($product->fourth_img)}}" alt="Current" class="rounded border me-2" style="max-width: 150px; max-height: 150px;">
                                                @endif
                                    ...
                                    <div class="mb-4">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" value="1" name="status" id="status_instock" @checked($product->status == 1)>
                                            <label class="form-check-label" for="status_instock">
                                                <i class="fas fa-check-circle text-success me-1"></i>Đang bán
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" value="0" name="status" id="status_outofstock" @checked($product->status == 0)>
                                            <label class="form-check-label" for="status_outofstock">
                                                <i class="fas fa-pause-circle text-danger me-1"></i>Tạm ngưng
                                            </label>
                                        </div>
                                    </div>
