    ...
    public function rules(): array
    {
        return [
            'product_name' => 'required|max:100|min:2|unique:products,product_name,'
                . $this->route('product')->product_id . ',product_id',
            ...
            'thumbnail' => 'nullable|image|mimes:png,jpg,jpeg|max:5120', // update thì cho phép bỏ trống
            'first_img' => 'nullable|image|mimes:png,jpg,jpeg|max:5120',
            'second_img' => 'nullable|image|mimes:png,jpg,jpeg|max:5120',
            'third_img' => 'nullable|image|mimes:png,jpg,jpeg|max:5120',
            'fourth_img' => 'nullable|image|mimes:png,jpg,jpeg|max:5120',
