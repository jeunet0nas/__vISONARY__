...
class UpdateCollectionRequest extends FormRequest
{
    ...
    {
        return [
            'collection_name' => 'required|max:255|unique:collections,collection_name,' . $this->route('collection')->collection_id . ',collection_id',
            'released' => 'required|numeric|min:2018|max:' . date('Y'),
            'collection_desc' => 'required|max:2000',
            'banner_img' => 'nullable|image|mimes:png,jpg,jpeg|max:5120'
        ];
    }
